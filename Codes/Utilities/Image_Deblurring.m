...
%----------------------------------------------------
function  [im PSNR SSIM]   =  Image_Deblurring(method, dict, nsig, Out_dir, Test_image_dir, image_name, blur_type, blur_par)
...
keyboard;
[par.bim par.fft_h]     =   Generate_blur_image(par.I, blur_type, blur_par, par.nSig);
keyboard;    
